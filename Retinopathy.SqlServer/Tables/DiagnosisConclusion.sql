...
(
  ...
  [RiskFactors]           NVARCHAR(MAX) DEFAULT '' NOT NULL,
  [DiagnosisAndFindings]  NVARCHAR(MAX) DEFAULT '' NOT NULL,
  [TreatmentPlan]         NVARCHAR(MAX) DEFAULT '' NOT NULL,
  [AdditionalInformation] NVARCHAR(MAX) DEFAULT '' NOT NULL,
